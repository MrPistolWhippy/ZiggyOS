...
// Full US QWERTY 8x8 Glyph Bitmaps Map
static const uint8_t font_sheet[256][8] = {
    [' '] = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    ['0'] = {0x3E,0x66,0x6E,0x76,0x66,0x66,0x3E,0x00},
    ['1'] = {0x18,0x38,0x18,0x18,0x18,0x18,0x3C,0x00},
    ['2'] = {0x3E,0x66,0x06,0x0C,0x18,0x30,0x7E,0x00},
    ['3'] = {0x7E,0x06,0x0C,0x3E,0x06,0x06,0x7E,0x00},
    ['4'] = {0x0C,0x1C,0x3C,0x6C,0x7E,0x0C,0x0C,0x00},
    ['5'] = {0x7E,0x60,0x7C,0x06,0x06,0x66,0x3C,0x00},
    ['6'] = {0x3E,0x60,0x7C,0x66,0x66,0x66,0x3C,0x00},
    ...
    ['S'] = {0x3E,0x60,0x3C,0x06,0x06,0x66,0x3C,0x00},
    ['T'] = {0x7E,0x18,0x18,0x18,0x18,0x18,0x18,0x00},
    ['U'] = {0x66,0x66,0x66,0x66,0x66,0x66,0x3C,0x00},
    ['V'] = {0x66,0x66,0x66,0x66,0x3C,0x24,0x18,0x00},
